...
use crate::models::{MilestoneDto, VersionDto};
...
pub fn routes() -> axum::Router<AppState> {
    ...
    axum::Router::new()
        ...
        .route("/milestones/{id}", axum::routing::patch(update_milestone).delete(delete_milestone))
        .route("/projects/{key}/releases", get(list_releases).post(create_release))
        .route("/releases/{id}", axum::routing::patch(update_release).delete(delete_release))
}
